import { AsYouType, formatNumber, isValidNumber, parsePhoneNumberFromString } from 'libphonenumber-js';
  ...
  computed: {
    ...
    formattedResult: function formattedResult() {
      ...
      if (this.mode === 'code') {
        ...
        var formatter = new AsYouType(); // eslint-disable-line
    ...
    initializeCountry: function initializeCountry() {
      ...
      return new Promise(function (resolve) {
        ...
        if (_this4.phone && _this4.phone[0] === '+') {
          var parsedPhone = parsePhoneNumberFromString(_this4.phone);
