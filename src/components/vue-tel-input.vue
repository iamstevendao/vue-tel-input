<template>
  <div ref="refRoot"
    ...
    <input v-model="data.phone"
           ...
           :aria-invalid="inputOptions['aria-invalid']"
           :aria-required="inputOptions['aria-required']"
           :aria-label="inputOptions['aria-label']"
           :aria-labelledby="inputOptions['aria-labelledby']"
           @blur="onBlur"
           @focus="onFocus"
           @input="onInput"
           @keyup.enter="onEnter"
