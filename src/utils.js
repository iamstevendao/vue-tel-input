...
export const allProps = [
  ...
  {
    name: 'dropdownOptions.disabledDialCode',
    default: false,
    type: Boolean,
    description: '',
    inDemo: false,
  ...
  {
    name: 'dropdownOptions.enabledCountryCode',
    default: false,
    type: Boolean,
    description: 'Enable country code in the input',
    inDemo: true,
  },
  {
    name: 'dropdownOptions.enabledFlags',
    default: true,
    type: Boolean,
    description: 'Enable flags in the input',
    inDemo: true,
  },
  {
