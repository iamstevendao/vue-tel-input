...
export const allProps = [
  ...
  {
    name: 'inputOptions.aria-invalid',
    default: undefined,
    type: [Boolean, String],
    description: 'Native input <code>aria-invalid</code> attribute',
    inDemo: false,
  },
  {
    name: 'inputOptions.aria-required',
    default: undefined,
    type: [Boolean, String],
    description: 'Native input <code>aria-required</code> attribute',
    inDemo: false,
  },
  {
    name: 'inputOptions.aria-label',
    default: undefined,
    type: String,
    description: 'Native input <code>aria-label</code> attribute',
    inDemo: false,
  },
  {
    name: 'inputOptions.aria-labelledby',
    default: undefined,
    type: String,
    description: 'Native input <code>aria-labelledby</code> attribute',
    inDemo: false,
  },
  {
